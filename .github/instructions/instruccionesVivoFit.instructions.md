...
- Aplica **estrictamente** los valores especificados:
  - **Fondo:** `#161616` (negro)
  - **Acentos:** `#FF9900` (naranja brillante)
...
static const Color background = Color(0xFF161616);      // #161616 (negro)
static const Color primary = Color(0xFFFF9900);         // #FF9900 (naranja brillante)
